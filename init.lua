...
local save_bell_positions = function()
   ...
   local file, err = io.open( BELL_SAVE_FILE, "wb")local S = minetest.get_translator(minetest.get_current_modname())local S = minetest.get_translator(minetest.get_current_modname())
...
if minetest.get_modpath("mcl_loot") then
	...
	items = { -- Table of possible loot items. This function selects between stacks_min and stacks_max of these.
		{
		itemstring = "bell:bell", -- Which item to select
